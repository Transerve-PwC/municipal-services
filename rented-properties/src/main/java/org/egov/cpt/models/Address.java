...
public class Address {
	...
	@Size(max = 256, message = "Tenent id must be between 0 and 256 to characters in length")
	...
	@NotNull
	@JsonProperty("area")
	@Size(min = 3, max = 100, message = "Locality must be between 3 to 100 characters in length")
	private String area;

	@JsonProperty("district")
	@Size(max = 256, message = "District must be between 0 to 256 characters in length")
	private String district;

	@JsonProperty("state")
	@Size(max = 256, message = "State must be between 0 to 256 characters in length")
	private String state;

	@JsonProperty("country")
	@Size(max = 256, message = "Country must be between 0 to 256 characters in length")
	...
	@Size(max = 256, message = "Landmark must be between 0 to 256 characters in length")
