...
public class MortgageApprovedGrantDetails {
	...
	@Size(max = 64, message = "Property detail id must be between 0 to 64 characters in length")
	@JsonProperty("propertyDetailId")
	private String propertyDetailId;

	@Size(max = 64, message = "Owner id must be between 0 to 64 characters in length")
	...
	@Size(max = 64, message = "Bank name must be between 0 to 64 characters in length")
	...
	@Size(max = 64, message = "Sanction letter number must be between 0 to 64 characters in length")
